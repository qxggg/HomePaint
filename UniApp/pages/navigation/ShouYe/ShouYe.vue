 					...
 					<view style="display: flex;height: 125px">
 						...
 						<view style="width: 50%;display: flex;flex-direction: column;justify-content: space-between;">
 							<view @click="share()"
 								...
 								<view
 									style="background-color: #FFF7E6;border-radius: 7px;width: 60px;font-size: 13px;margin-right: 10px;display: flex;justify-content: space-around;align-items: center;height: 25px;">
 									<image src="../../../static/navgiation/ShouYe/share.png" mode="widthFix"
